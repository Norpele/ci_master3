                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select" id="txdepartment" onchange="load_employment(this.value)"></select>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txcode" class="form-control" name="lname-column">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-select" id="txatasan"></select>
                            ...
                            <div class="modal-footer">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success ms-1 btn-submit" onclick="simpan_data()">
